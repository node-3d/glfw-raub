...
// JS_METHOD(setWindowPosCallback);
// JS_METHOD(setWindowSizeCallback);
// JS_METHOD(setWindowCloseCallback);
// JS_METHOD(setWindowRefreshCallback);
// JS_METHOD(setWindowFocusCallback);
// JS_METHOD(setWindowIconifyCallback);
// JS_METHOD(setWindowMaximizeCallback);
// JS_METHOD(setFramebufferSizeCallback);
// JS_METHOD(setWindowContentScaleCallback);
...
// JS_METHOD(setCharCallback);
// JS_METHOD(setCharModsCallback);
// JS_METHOD(setMouseButtonCallback);
// JS_METHOD(setCursorPosCallback);
// JS_METHOD(setCursorEnterCallback);
// JS_METHOD(setScrollCallback);
// JS_METHOD(setDropCallback);
